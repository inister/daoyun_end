...
public class TestMybatis {
    ...
    @Test
    public void testDictionaryFindAll() throws IOException {
        InputStream is = Resources.getResourceAsStream("SqlMapConfig.xml");
        SqlSessionFactory factory = new SqlSessionFactoryBuilder().build(is);
        SqlSession sqlSession = factory.openSession();
        DictionaryDao dictionaryDao = sqlSession.getMapper(DictionaryDao.class);
    ...
    @Test
    public void testClassFindTeacherCourse() throws IOException {
        InputStream is = Resources.getResourceAsStream("SqlMapConfig.xml");
        SqlSessionFactory factory = new SqlSessionFactoryBuilder().build(is);
        SqlSession sqlSession = factory.openSession();
        ClassDao classDao = sqlSession.getMapper(ClassDao.class);
        List<Class> classList = classDao.findAllTeacherCourse("池芝标");
